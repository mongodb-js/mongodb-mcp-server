...
// Note: CommonArgs, AtlasArgs, and validation error messages have been moved to
// @mongodb-js/mcp-tools-atlas package. Only zEJSON remains here for MongoDB tools.
