...
export class ListAlertsTool extends AtlasToolBase {
    ...
    public description =
        "List triggered alerts for a MongoDB Atlas project. These are alerts that have fired (alert events), not the alert configurations that define them. Defaults to OPEN alerts; set status to TRACKING or CLOSED to see others.";
