...
export type TransportRunnerConfig = {
    ...
    /**
     * An optional list of tools to be registered to the MongoDB MCP Server.
     * When not provided, MongoDB MCP Server will not register any tools other
     * than the internal tools that it knows of.
     *
     * Tools specified here will be registered alongside the default MongoDB MCP
     * Server tools. It is important to ensure that the name of each of the
     * additional tools are unique at-least for the running MongoDB MCP Server
     * instance.
     *
     * Note: Additional tools cannot use the same name as that of internal
     * MongoDB tools.
     *
