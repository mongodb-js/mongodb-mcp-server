    ...
    return {
        ...
        closeBundle() {
            ...
            for (const [toolName, componentName] of Object.entries(toolToComponentMap)) {
                ...
                // Generate .ts file for tsc to compile to dist/
                // Generate .js file for development/test (dynamic imports use .js extension)
...
`;
                ...
                writeFileSync(join(toolsDir, `${toolName}.js`), toolModuleContent);
