...
export class ApiClient {
    ...
    private async sendAuthEvents(events: object[], signal?: AbortSignal): Promise<void> {
        const authHeaders = await this.authProvider?.getAuthHeaders();
        if (!authHeaders) {
    ...
    private async sendUnauthEvents(events: object[], signal?: AbortSignal): Promise<void> {
