...
import type { Server } from "@mongodb-js/mcp-core";
...
export interface IMongoDBSession extends IToolSession {
  ...
  serviceProvider: import("@mongosh/service-provider-node-driver").NodeDriverServiceProvider;
  ...
  ): Promise<{ errorHandled: boolean; result: import("@modelcontextprotocol/sdk/types.js").CallToolResult }>;
