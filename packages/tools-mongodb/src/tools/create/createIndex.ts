...
const vectorSearchIndexDefinition = z
    .object({
        type: z.literal("vectorSearch"),
        fields: z
            .array(z.discriminatedUnion("type", [filterFieldSchema, vectorFieldSchema, autoEmbedFieldSchema]))
            .nonempty()
...
const atlasSearchIndexDefinition = z
    .object({
            ...
            .object({
                dynamic: z
                    .union([
                        ...
                        z
                            .object({
                                typeSet: z.string().describe("Name of a type set defined in this index's `typeSets`."),
                            })
                            .strict(),
                    ])
                    .optional()
...
const CreateIndexArgsShapeVariants = connectionScopedArgsShape({
    ...CollOperationArgs,
...
export class CreateIndexTool extends MongoDBToolBase {
    ...
    public argsShape(): typeof CreateIndexArgsShapeVariants.preconfigured {
        return this.selectConnectionScopedArgsShape(CreateIndexArgsShapeVariants);
    }
    public override outputSchema(): typeof CreateIndexOutputSchema {
