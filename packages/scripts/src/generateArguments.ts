...
function updateServerJsonEnvVars(envVars: ArgumentInfo[]): void {
    const serverJsonPath = join(__dirname, "..", "..", "..", "packages", "mongodb-mcp-server", "server.json");
    const packageJsonPath = join(__dirname, "..", "..", "..", "packages", "mongodb-mcp-server", "package.json");
