import { StreamableHttpRunner, type StreamableHttpTransportRunnerConfig } from "@mongodb-js/mcp-http-runners";
...
describe("createSessionConfig", () => {
    ...
    const startRunner = async (
        config: {
            ...
            createSessionConfig?: StreamableHttpTransportRunnerConfig["createSessionConfig"];
        } = {}
