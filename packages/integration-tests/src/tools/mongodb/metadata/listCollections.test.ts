...
describeWithMongoDB({
    ...
    fn: (integration) => {
        ...
        validateThrowsForInvalidArguments({ integration, name: "list-collections", args: databaseInvalidArgs });
        ...
        describe("with existing database", () => {
            it("returns collections", async () => {
                ...
                const { collections: contentData2 } = JSON.parse(
