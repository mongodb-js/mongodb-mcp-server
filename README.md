...
| `MDB_MCP_SKIP_SKILLS_INSTALL`                                                                  | `false`                                                                                                                                            | Setup-only. When set to `"true"`, the `setup` wizard skips the MongoDB Agent Skills install step without prompting. Accepts only `"true"` or `"false"`.                                                  |
