...
| `MDB_MCP_OUTPUT_FORMAT` / `--outputFormat`                                                     | `"json"`                                                                                                                                           | The serialization for tool result data: 'json' (default) or 'gcf' (Graph Compact Format), which encodes result documents more compactly for fewer tokens, applied per result only when it is smaller and lossless.                                                                                                                                                                                                    |
