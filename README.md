...
[![Install in Windsurf](https://img.shields.io/badge/Windsurf-Install_Server-F9F3E9?logo=windsurf)](windsurf:cascade_plugins/install?{"title":"MongoDB","id":"mongodb-mcp-server","link":"https://github.com/mongodb-js/mongodb-mcp-server","description":"A Model Context Protocol server for interacting with MongoDB Atlas.","commands":{"npx":{"template":{"command":"npx","args":["-y","mongodb-mcp-server"],"env":{"MDB_MCP_CONNECTION_STRING":"<CONNECTION_STRING>"}},"variables":[{"name":"<CONNECTION_STRING>","title":"Connection string", "description":"MongoDB connection string for direct database connections.","link":"https://github.com/mongodb-js/mongodb-mcp-server#configuration-options"}]}}})
