...
| `MDB_MCP_QUERY_MAX_TIME_MS` / `--queryMaxTimeMs`                                               | `30000`                                                                                                | Maximum server-side execution time in milliseconds for query operations (find, aggregate, count, etc.). This is enforced by MongoDB and protects against long-running queries. Set to 0 to disable. |
