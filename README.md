...
| `MDB_MCP_MAX_ACTIVE_CONNECTIONS` / `--maxActiveConnections`                                    | `10`                                                                                                                                               | Maximum number of MongoDB connections the server can hold open at once. When exceeded, the least-recently-used connection is closed and its connectionId revoked. The preconfigured connection does not count towards the limit.                                                                                                         |
