...
describe("StreamsDiscoverTool", () => {
    ...
    describe("find-processor", () => {
        it("should search across all workspaces and find processor", async () => {
            ...
            mockApiClient.getStreamProcessor!.mockRejectedValueOnce(new Error("Not found")).mockResolvedValueOnce({
                name: "target-proc",
                state: "STARTED",
                tier: "SP10",
            });
    ...
    describe("list-all-processors", () => {
        it("should aggregate processors from multiple workspaces", async () => {
            ...
            mockApiClient
                .getStreamProcessors!.mockResolvedValueOnce({
    ...
    describe("get-logs", () => {
        it("should decompress and return operational logs", async () => {
            ...
            mockApiClient.downloadOperationalLogs!.mockResolvedValue(compressed.buffer);
        ...
        it("should use audit log API when logType is audit", async () => {
            ...
            const compressed = gzipSync(Buffer.from(logData));
            mockApiClient.downloadAuditLogs!.mockResolvedValue(compressed.buffer);
    ...
    describe("get-networking", () => {
        it("should return PrivateLink and VPC peering details", async () => {
            ...
            mockApiClient.listActivePeeringConnections!.mockResolvedValue({
                results: [{ id: "peer-1", status: "ACTIVE" }],
            });
            ...
            expect(text).toContain("VPC Peering");
        ...
        it("should include account details when cloudProvider and region are provided", async () => {
            ...
            mockApiClient.listActivePeeringConnections!.mockResolvedValue({ results: [] });
        ...
        it("should handle empty networking results", async () => {
            ...
            expect(text).toContain("No active VPC peering connections found");
        });
    });
